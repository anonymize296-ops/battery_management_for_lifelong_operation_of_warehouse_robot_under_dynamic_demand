...
"""
Axis-Aligned Rectangle with bottom-left <x1,y1> corner and top-right <x2,y2> corner
"""
class Rectangle:
    ...
    rect - <x1,y1, x2,y2> Bottom-Left corner and Top-Right corner 
    """
    def is_rectangle_overlap(self, rect):
        left_below = (rect.x1 < self.x2) and (rect.y1 <= self.y2)
        right_above = (self.x1 < rect.x2) and (self.y1 < rect.y2)

        return left_below and right_above 
