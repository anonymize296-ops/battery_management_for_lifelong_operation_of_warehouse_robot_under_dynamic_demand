...
##
- Fig 12: Comparison of energy consumption between the MILP and rule-based approaches.
    - scenarios/comparision/*.json scenario files
    - output/scenario_1_milp/comparions/ all the output files
    - scenarios/comparison/plotter_scenario_1_compare_rulebase_goalprogramming.json
- Fig 2: The MILP based approach sucessfully meets the given demand requirements
    - scenarios/scenario_2_trapezoidal_achievable_.json
    - output/scenario_1_milp/scenario_2_trapezoidal_achievable.csv
    - output/scenario_1_milp/scenario_2_bcs_trapezoidal_achievable_2.csv
- Fig 3: The MILP based approach demonstrates limitations under exceptionally high demand scenarios
    - scenarios/scenario_2_trapezoidal_not_achievable.json
    - output/scenario_1_milp/scenario_2_trapezoidal_not_achievable.csv
    - output/scenario_1_milp/scenario_2_bcs_trapezoidal_not_achievable.csv
## License
