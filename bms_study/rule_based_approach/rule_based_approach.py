...
class Rule_Based_Approach:
    def __init__(self, g_id, m_id, global_blackboard):
        ...
        self.Tmin = 10  # default
        #self.Tmax = 6.
        self.Tmax = 14. #default
        self.T = -1.
        self.Tcharge = -1.
        self.tau_c = 10.
        self.tau_d = 1.
        self.Bmin = 25. # default
        self.Bdead= 20.
        self.Bth = 35.  # default
        self.Nc = -1
        self.Nc_free = -1
    ...
    def algorithm(self):
        ...
        if self.Nd == 0:
            ...
            print(self.Tcharge ,"CHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH")
    ...
    def solve(self):
        ...
        self.get_battery_percentage()
        demand_actual = 0
        for robot_battery in self.battery_percentage:
            if robot_battery[3] == Mode_Of_Operation.Work_Mode:
                demand_actual += 1
